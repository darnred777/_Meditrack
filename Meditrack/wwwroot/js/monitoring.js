                ...
                "render": function (data) {
                    return `
                        <div class="w-75 btn-group" role="group">
                            <a href="/admin/monitoring/upsertmonitoring?monitoringID=${data}" class="btn btn-info mx-2"><i class="bi bi-pencil-square"></i>Edit</a>
                            <a href="/admin/monitoring/deletemonitoring?monitoringID=${data}" class="btn btn-danger mx-2"><i class="bi bi-trash-fill"></i>Delete</a>
                        </div>
                    `
                },
                "width": "20%"
