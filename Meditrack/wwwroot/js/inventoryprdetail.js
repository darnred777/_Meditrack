                ...
                "render": function (data) {
                    return `
                        <div class="w-75 btn-group" role="group">
                            <a href="/inventoryofficer/prtransaction/viewprdetails?prviewId=${data}" class="btn btn-primary mx-2"><i class="bi bi-pencil-square"></i>Edit</a>                     
                            <a href="/inventoryofficer/prtransaction/viewprdetails?prviewId=${data}" class="btn btn-primary mx-2"><i class="bi bi-pencil-square"></i>Delete</a>                     
                        </div>
                    `
                },
                "width": "20%"
